...
VALUES
	...
	(4,'设备管理',0,1,'manage','go_4','0','photo','0'),
	(5,'用户管理',0,1,'manage','go_5','0','user','0'),
	(6,'服务器管理',0,1,'manage','go_6','0','server','0'),
	(7,'报警管理',0,1,'manage','go_7','0','warning','0'),
	(8,'客户支持',0,1,'customer','index','0','suitcase','0'),
	(9,'其他',0,0,'manage','go_9','0','user','10'),
	...
	(34,'断面列表',3,1,'break','index','0','cog','0'),
	(139,'断面增加',34,1,'break','add','0','cog','0'),
	(140,'断面修改',34,0,'break','modify','0','cog','0'),
	(141,'断面删除',34,0,'break','delete','0','cog','0'),

	(35,'N级断面列表',3,1,'breakserial','index','0','cog','0'),
	(142,'N级断面增加',35,1,'breakserial','add','0','cog','0'),
	(143,'N级断面修改',35,0,'breakserial','modify','0','cog','0'),
	(144,'N级断面删除',35,0,'breakserial','delete','0','cog','0'),

	(37,'环境列表',3,1,'env','index','0','cog','0'),
	(145,'环境信息增加',37,1,'env','add','0','cog','0'),
	(146,'环境信息修改',37,0,'env','modify','0','cog','0'),
	(147,'环境信息删除',37,0,'env','delete','0','cog','0'),

	(38,'疾病属性列表',3,1,'disease','index','0','cog','0'),
	(148,'疾病属性增加',38,1,'disease','add','0','cog','0'),
	(149,'疾病属性修改',38,0,'disease','modify','0','cog','0'),
	(150,'疾病属性删除',38,0,'disease','delete','0','cog','0'),

	(41,'传感器列表',4,1,'device','index','0','cog','0'),
	(401,'传感器增加',41,1,'device','add','0','cog','0'),
	(402,'传感器修改',41,0,'device','modify','0','cog','0'),
	(403,'传感器删除',41,0,'device','delete','0','cog','0'),

	(42,'传感器数据列表',4,1,'device_data','index','0','cog','0'),
	(404,'传感器数据增加',42,1,'device_data','add','0','cog','0'),
	(405,'传感器数据修改',42,0,'device_data','modify','0','cog','0'),
	(406,'传感器数据删除',42,0,'device_data','delete','0','cog','0'),

	(43,'传感器基础数据列表',4,1,'sensor_base','index','0','cog','0'),
	(407,'传感器基础数据增加',43,1,'sensor_base','add','0','cog','0'),
	(408,'传感器基础数据修改',43,0,'sensor_base','modify','0','cog','0'),
	(409,'传感器基础数据删除',43,0,'sensor_base','delete','0','cog','0'),

	(44,'设备类型列表',4,1,'device_type','index','0','cog','0'),
	(410,'设备类型增加',44,1,'device_type','add','0','cog','0'),
	(411,'设备类型修改',44,0,'device_type','modify','0','cog','0'),
	(412,'设备类型删除',44,0,'device_type','delete','0','cog','0'),
	...
	(504,'项目关联',50,1,'project_user','index','0','heart','0'),
	(505,'修改关联',50,0,'project_user','update','0','wrench','0'),
    
	(70,'报警模型列表',7,1,'alarm','index','0','user','0'),
	(701,'添加模型',70,1,'alarm','add','0','user','0'),
	(702,'修改模型',70,0,'alarm','modify','0','user','0'),
	(703,'删除模型',70,0,'alarm','delete','0','user','0'),
...
-- ----------------------------
INSERT INTO `tb_project_type` VALUES ('1', 'type1', '0', '2016-06-06 18:32:08');
INSERT INTO `tb_project_type` VALUES ('2', 'type2', '0', '2016-06-06 18:32:16');
...
-- ----------------------------
INSERT INTO `tb_slop_info` VALUES ('1', '杭徽高速公路G56101号边坡-1', '坡高5.0m。', '1', '2006-12-26 15:29:54', '浙江安徽交界', '120.218107', '30.29573',  '0', '0', '1', '1', '杭徽高速公路藻溪至於潜段', 'k57+550', 'K57+650', '120.2', '30.3', '20.0', '第一级SNS主动网+预应力锚杆（8m）防护；第二级SNS主动网+预应力锚杆（6m）防护。', '/upload/slop_info/1/design.jpg', null, null, null, '/upload/slop_info/1/build.jpg', null, '1', '3', '2', '1', '1', '1', '2016-06-06 18:35:22');
INSERT INTO `tb_slop_info` VALUES ('2', '杭徽高速公路G56101号边坡-2', '坡高5.0m。', '1', '2006-12-26 15:29:54', '浙江安徽交界', '120.206734', '30.298255',  '0', '0', '1', '1', '杭徽高速公路藻溪至於潜段', 'k57+550', 'K57+650', '120.2', '30.3', '20.0', '第一级SNS主动网+预应力锚杆（8m）防护；第二级SNS主动网+预应力锚杆（6m）防护。', '/upload/slop_info/1/design.jpg', null, null, null, '/upload/slop_info/1/build.jpg', null, '1', '3', '2', '1', '1', '1', '2016-06-06 18:35:22');
INSERT INTO `tb_slop_info` VALUES ('3', '杭徽高速公路G56101号边坡-3', '坡高5.0m。', '1', '2006-12-26 15:29:54', '浙江安徽交界', '120.199152', '30.290553',  '0', '0', '1', '1', '杭徽高速公路藻溪至於潜段', 'k57+550', 'K57+650', '120.2', '30.3', '20.0', '第一级SNS主动网+预应力锚杆（8m）防护；第二级SNS主动网+预应力锚杆（6m）防护。', '/upload/slop_info/1/design.jpg', null, null, null, '/upload/slop_info/1/build.jpg', null, '1', '3', '2', '1', '1', '1', '2016-06-06 18:35:22');
INSERT INTO `tb_slop_info` VALUES ('4', '杭徽高速公路G56101号边坡-4', '坡高5.0m。', '1', '2006-12-26 15:29:54', '浙江安徽交界', '120.196457', '30.304523',  '0', '0', '1', '1', '杭徽高速公路藻溪至於潜段', 'k57+550', 'K57+650', '120.2', '30.3', '20.0', '第一级SNS主动网+预应力锚杆（8m）防护；第二级SNS主动网+预应力锚杆（6m）防护。', '/upload/slop_info/1/design.jpg', null, null, null, '/upload/slop_info/1/build.jpg', null, '2', '3', '2', '1', '1', '1', '2016-06-06 18:35:22');
...
-- ----------------------------
INSERT INTO `tb_device_info` VALUES ('5', '集成箱1', '传感器作用收集长度', '1', null, null, 'v=a+b', '5', '1', '7', '分组类型?', '100', '1', '2', '120', '30', '20', '20', '1', '30', '45', '朝北', '', '2016-06-06 18:51:11');
INSERT INTO `tb_device_info` VALUES ('6', '集成箱2', '收集重量', '2', null, null, 'm=a*b', '6', '2', '8', '分组类型？', '100', '2', '2', '120', '30', '25', '12', '5', '45', '0', '朝南', '', '2016-06-06 18:51:43');
