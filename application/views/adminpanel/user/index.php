            ...
            <div class='panel-body '>
                <table class="table table-hover dataTable">
                    ...
                    <?php foreach ($data_list as $k => $v): ?>
                        <tr>
                            <td><input type="checkbox" name="pid[]" value="<?php echo $v['operator_id'] ?>"/></td>
                            <td> <?php if (isset($v['is_lock']) && $v['is_lock']): ?><span
                            ...
                            <td>
                                <?php aci_ui_a($folder_name, 'user', 'edit', $v['operator_id'], ' class="btn btn-default btn-xs"', '<span class="glyphicon glyphicon-edit"></span> 修改') ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
...
<script language="javascript"
        type="text/javascript">var folder_name = "<?php echo $folder_name?>";require(['/scripts/<?php echo $folder_name?>/user/index.js']); </script>
