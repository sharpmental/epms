...
<body>
	...
	<div class="row">
		<h4>
			欢迎使用本系统.请使用新版本的浏览器并不要关闭javascript，否则影响正常使用。
			</h3>
			<h5>选择下方对应链接进入系统。默认管理帐号admin/0002
				...
				<div class="caption">
					...
					<a
						...
						if (isset ( $this->session->userdata ['xurl'] ) && $this->session->userdata ['xurl'])
							echo site_url ( $this->session->userdata ['xurl'] . '/project' );
						else
			...
			<div class="thumbnail">
				...
				<div class="caption">
					...
					<a
						href="<?php
						if (isset ( $this->session->userdata ['xurl'] ) && $this->session->userdata ['xurl'])
							echo site_url ( $this->session->userdata ['xurl'] . '/user' );
						else
							echo site_url ( 'adminpanel' );
						?>"
						class="btn btn-info btn-md" role="button">&nbsp;&nbsp;进入&nbsp;&nbsp;</a>
	...
	<div class="mastfoot">
		<div class="inner">
			<p>
				...
				by <a href="mailto:shunmin.wu@gmail.com">WSM</a>.
			</p>
		</div>
	</div>
