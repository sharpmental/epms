...
define('SITE_NAME','EPMS管理系统 ');
define('WEBSITE_BASE_NAME','EPMS管理系统');

define('SUPERADMIN_GROUP_ID',  1);

define('ADMIN_URL_PATH',  '/adminpanel/');
define('ADMIN_CSS_PATH',  '/css/adminpanel/');
define('ADMIN_IMG_PATH',  '/images/adminpanel/');
